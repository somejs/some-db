...
Db.prototype.init= function(options) {
    db= this
    Client.prototype.init.call(db, options)
    db.observer.callback= function (err, client) {                              ;console.log('наблюдатель:', err, client.ready)
        ready= false
        ...
        db.ready= ready                                                         ;console.log('db', db.ready)
    }
}
