...
var Client= module.exports= Model.Mapper({
    ...
    type: Model.Property({ enumerable: false,
        value: 'client',
    }),
     ...
     * Наблюдатели
     */
    observers: Model.Property({ enumerable: false,
        type: Array,
    }),
 ...
 */
Client.prototype.notify= function () {                                          ;console.log('уведомить наблюдателей', this.observers)
